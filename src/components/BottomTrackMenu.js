    ...
    <div className={!openSlideTrack ? "bottomNav" : "bottomNavOpen"}>
      ...
      >
        ...
        >
          <Grid item xs={2}>
            ...
            >
              ...
              <SliderVolume onChangeVolume={onChangeVolume} volume={volume} />
            </Grid>
          </Grid>
          <Grid item xs={10}>
            <SliderPosition
            ...
            >
              ...
              >
                {trackData.title.length > 15
                  ? trackData.title.substring(0, 15) + "..."
                  : trackData.title}
              </div>
              <div
                style={{
              ...
              >
                - {minutesLeft.toString().length === 1 && "0"}
                {minutesLeft} : {secondsLeft.toString().length === 1 && "0"}
                {secondsLeft}
              </div>
            </Grid>
            <div style={{ paddingTop: "5px", position: "relative" }}>
              ...
              <div className="FavoriteIcon">
                <IconButton
                  size="large"
                  color="secondary"
                  onClick={() => addToFavorites(trackData)}
                >
                  <Favorite
                    color="secondary"
                ...
                {favorites.map(
                  x =>
                    x.id === trackData.id && (
                      <div
                        style={{ position: "absolute", bottom: -14, left: 6 }}
                      >
                        <Chip
                          label="Saved"
                          color="secondary"
        ...
        <Grid
          ...
          alignItems="flex-start"
          onClick={() => {
            onSearchAuthor(trackData.user.id);
            handleOpenSlideTrack();
          }}
        >
          <Grid item xs={3}>
          ...
          <Grid item xs={7}>
            <p style={{ paddingTop: "5px", color: "grey", fontSize: "15px" }}>
              Author: {trackData.user.name}
            </p>
          </Grid>
        </Grid>
      </div>
